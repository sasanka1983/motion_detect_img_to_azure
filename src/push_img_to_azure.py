...
class push__img_to_azure:
    def __init__(self,image_path,connection_string):
        self.connection_string=connection_string
        self.image_path=image_path
        self.bridge= CvBridge()
        self.image_count=1
        image_sub = rospy.Subscriber("motion_detection_node_image",Image, self.callback)
...
def main(args):
    rospy.init_node('push_image_to_azure_node', anonymous=True)
    push_to_azure=push__img_to_azure(args[1],args[2])
